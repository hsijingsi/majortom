<%@ page import="com.woodyallen.entity.Expression" %>
<%@ page import="java.util.List" %>
<%@ page import="com.woodyallen.commons.PageBean" %>
...
<html>
  ...
  <body>
    <form action="<%=request.getContextPath()+"/woodyallen/publish"%>" method="post">
    ...
    <%
      ...
      if(null==pageBean){
          response.sendRedirect(application.getContextPath()+ "/woodyallen/list");
        return;
      }
    %>
    <div class="nav">
      <a href="<%=application.getContextPath()+"/woodyallen/list?page="+pageBean.getPageHome()%>"> 首页 </a>
      <a href="<%=application.getContextPath()+"/woodyallen/list?page="+pageBean.getPageUp()%>">上一页</a>
      <%
        for (Integer num : pageBean.getPageNums()) {
      %>
      <a href="<%=application.getContextPath()+"/woodyallen/list?page="+num%>"><%=num%></a>
      <%
        }%>
      <a href="<%=application.getContextPath()+"/woodyallen/list?page="+pageBean.getPageDown()%>">下一页</a>
      <a href="<%=application.getContextPath()+"/woodyallen/list?page="+pageBean.getPageEnd()%>">尾页</a>
    </div>
    ...
    <div class="expression">
      ...
      <div class="expression_foot">
        ...
        <a class="delete" href="<%=application.getContextPath()+"/woodyallen/delete?id="+exp.getExpressionId()%>">删除</a>
      </div>
    </div>
    <%
      }
